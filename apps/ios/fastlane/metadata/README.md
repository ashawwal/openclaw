...
DELIVER_METADATA=1 bundle _2.6.9_ exec fastlane ios metadata release_version:2026.7.2 app_store_revision:1
```
...
```bash
cd apps/ios
DELIVER_RELEASE_NOTES=1 bundle _2.6.9_ exec fastlane ios metadata release_version:2026.7.2 app_store_revision:1
```
...
```bash
cd apps/ios
DELIVER_METADATA=1 DELIVER_SCREENSHOTS=1 bundle _2.6.9_ exec fastlane ios metadata release_version:2026.7.2 app_store_revision:1
```
