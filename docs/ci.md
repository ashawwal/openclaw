...
| `ios-screenshot-shard`             | Two device-family shards: iPhone plus Watch in one job, and 13-inch iPad in the other; scenarios stay serial within each device                                                                                                                                                                          | Screenshot-risk changes and manual CI                  |
| `ios-screenshot-evidence`          | Hosted reducer that verifies exact artifact/family topology, digests, OpenClaw-managed capture-attempt outcomes, and run provenance before publishing the canonical release screenshot artifact                                                                                                          | After both screenshot shards                           |
