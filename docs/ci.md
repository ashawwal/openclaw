...
| `ios-screenshot-evidence`          | Hosted reducer that verifies the exact family union, digests, retry results, and run provenance before publishing the canonical release screenshot artifact                                                                                                                                              | After both screenshot shards                           |
